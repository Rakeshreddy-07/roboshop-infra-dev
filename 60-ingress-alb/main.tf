module "alb" {
  ...
  security_groups = [local.alb_ingress_sg_id.value]
...
resource "aws_lb_listener" "https" {
  ...
  certificate_arn   = local.ingress_alb_cert_arn
  ...
  default_action {
    ...
    fixed_response {
      ...
      message_body = "<h1>This is from forntend ingress alb with https<h1>"
      status_code  = "200"
    }
  }
}
